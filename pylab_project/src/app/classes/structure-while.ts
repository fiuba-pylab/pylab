    ...
    override execute(amountToAdd?: number): {amount: number, finish: boolean}{
        ...
        if(this.currentLine == this.lines.length && evaluate(condition_replaced)){
            ...
            if(this.collectionInfo){
                ...
                variables[this.collectionInfo.tempVarName] = collection.values[collectionIsArray?index:Object.keys(collection?.values)[index]]//.push(collection.values[collectionIsArray?index:Object.keys(collection?.values)[index]])
            }
